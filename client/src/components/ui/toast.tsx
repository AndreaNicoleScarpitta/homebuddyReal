...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Mobile: anchor above the bottom nav (h-14 = 56 px + safe-area buffer).
      // sm+: Radix default — bottom-right corner, grows upward.
      "fixed bottom-20 z-[100] flex max-h-screen w-full flex-col p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
